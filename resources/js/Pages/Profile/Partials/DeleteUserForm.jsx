        ...
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Uma vez deletada todas suas informações e dados serão permanetemente deletados do sistema.
                </p>
            </header>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Uma vez deletada todas suas informações e dados serão permanetemente deletados do sistema.
                        Por favor digite sua senha para confirmar que deseja que sua conta seja permanentemente deletada.
                    </p>
